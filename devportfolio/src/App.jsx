  ...
  return (
    <>
      ...
      <div id="about" className="h-screen w-full bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: "url('/assets/img3.jpg')" }}>
        <h1 className="text-white text-2xl sm:text-3xl text-center px-4">I am Wanjawa Frandel, I posses a myriad of valuable skills 
          that I believe are requisite for transforming the world today and make it a better place for everyone who calls it home. 
          ...
          it materialises and leave a mark when the opportunity finally materialises. This distinguishes self from the over 7 billion 
          people who are in our planet today.
          ...
          hence hastening the realisation of the #17SDGs as envisioned by the United Nations.
          ...
          Here is the catch though: there is only one way to find out.</h1>
      </div>
